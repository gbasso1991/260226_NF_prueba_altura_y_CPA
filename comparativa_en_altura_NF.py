...
#%% Obtengo ciclos promedio - Todo a 300 kHz
ciclo_top = glob("prueba_altura/*top/**/*ciclo_promedio_H_M.txt")

ciclo_center = glob("prueba_altura/*center/**/*ciclo_promedio_H_M.txt")

ciclo_bottom = glob("prueba_altura/*bottom/**/*ciclo_promedio_H_M.txt")

print('ciclo top')
for p in ciclo_top:
    print('  ',p)
print('ciclo center')
for p in ciclo_center:
    print('  ',p)
print('ciclo bottom')
for p in ciclo_bottom:
    print('  ',p)

_,_,_, H_top,M_top,_ = lector_ciclos(ciclo_top[0])
_,_,_, H_center,M_center,_ = lector_ciclos(ciclo_center[0])
...
dir_res_top = glob("prueba_altura/*top/**/*resultados.txt")
dir_res_center = glob("prueba_altura/*center/**/*resultados.txt")
dir_res_bottom = glob("prueba_altura/*bottom/**/*resultados.txt")
